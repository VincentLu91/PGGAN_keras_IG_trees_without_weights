...
random_seed = 1000
dataset = None
#dataset = dict(h5_path='demo1.h5', resolution=128, max_labels=0, mirror_augment=True)
...
if 1:
    ...
    dataset = dict(h5_path='trees_dataset_cropped.h5', resolution=128, max_labels=0, mirror_augment=True)
